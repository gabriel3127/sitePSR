        ...
        <div className="container h-14 flex items-center justify-between gap-4">
          ...
          <button onClick={() => { refreshCart(); setCartOpen(true) }}
            ...
            <div className="relative">
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 bg-[#1A50A0] text-white text-[9px] font-bold w-3.5 h-3.5 rounded-full flex items-center justify-center">
            ...
            {imagens.length > 1 && (
              <div className="relative mt-3 group/carousel">
                ...
                {activeImg < imagens.length - 1 && (
                  <button
                    onClick={() => setActiveImg(i => Math.min(imagens.length - 1, i + 1))}
