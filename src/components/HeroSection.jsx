...
// Imagens servidas de /public — URL estável, funciona com preload no index.html
const heroImg    = "/hero-packaging.webp"
const heroImg800 = "/hero-packaging-800.webp"
const heroImg400 = "/hero-packaging-400.webp"
...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Fundo decorativo — CSS puro, zero JavaScript */}
            ...
            <TiltCard className="relative" intensity={6}>
              ...
              >
                <img
                  ...
                  sizes="(max-width: 480px) 100vw, (max-width: 768px) 100vw, (max-width: 1200px) 400px, 600px"
