        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/depoimentos" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Depoimentos</Link>
              <Link to="/links" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Link na Bio</Link>
            </div>
          </div>
