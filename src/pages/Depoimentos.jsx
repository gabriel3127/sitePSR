...
const SETOR_STYLE = {
  Alimentação: { bg: "bg-orange-100 text-orange-700", dot: "bg-orange-500" },
  Varejo:      { bg: "bg-blue-100 text-blue-700",    dot: "bg-blue-500" },
  Confeitaria: { bg: "bg-pink-100 text-pink-700",    dot: "bg-pink-500" },
  Eventos:     { bg: "bg-purple-100 text-purple-700", dot: "bg-purple-500" },
  default:     { bg: "bg-gray-100 text-gray-600",    dot: "bg-gray-400" },
}

const getSe = (s) => SETOR_STYLE[s] || SETOR_STYLE.default
    ...
    <div className="container relative py-16 md:py-24">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-2xl">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white leading-tight">
          O que nossos<br />
          <span className="text-[#F5C200]">clientes dizem</span>
        </h1>
...
const ReviewCard = ({ review, index }) => {
  return (
    ...
    >
      ...
      {/* texto */}
      <p className="text-sm text-gray-500 leading-relaxed flex-1">"{review.text}"</p>
    </motion.div>
  )
}
